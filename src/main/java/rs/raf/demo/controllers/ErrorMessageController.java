...
public class ErrorMessageController {
    ...
    public ErrorMessage create(@Valid @RequestBody ErrorMessage student){
        System.out.println("adding errors");
        return errorMessageService.save(student);
    }

    @PutMapping(consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public ErrorMessage update(@Valid @RequestBody ErrorMessage student){
        return errorMessageService.save(student);
    }
